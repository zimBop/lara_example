    ...
    <div class="row h-100 align-items-center">
        <div class="col-sm-12 col-md-5  mx-auto">
            ...
            <div class="card card-block fadeIn animated">
                <div class="p-3">
                    <div class="form-side">
                        <form action="{{ route(R_ADMIN_LOGIN_SUBMIT) }}" method="post" class="form-horizontal mt-2" id="auth-form">
                            @csrf
                            ...
                            <div class="form-group text-center row">
                                <div class="col-12">
                                    <button class="btn btn-info btn-block" type="submit" name="submit" value="1">Sign in</button>
                                </div>
                            </div>
